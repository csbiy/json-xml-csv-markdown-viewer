...
class _XmlEditorState extends State<XmlEditor> {
  ...
  @override
  void didUpdateWidget(XmlEditor oldWidget) {
  ...
  void _validate() {
    setState(() {
      _validation = Validators.validateXml(_controller.text);
    });
  }
          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                SizedBox(width: 8),
                Text('Valid XML', style: TextStyle(color: Colors.green)),
              ],
            ),
          ),
        Expanded(
